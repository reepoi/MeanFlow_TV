...
if __name__ == "__main__":
    ...
    # trainer_backward = Trainer(model_original, p_init, p_target, batch_size, method='Original')
    trainer_combined = Trainer(model_combined, p_init, p_target, batch_size, method='Combined')
